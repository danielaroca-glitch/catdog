...
**Módulo:** _MODULE-[ID] — Nome do módulo (conforme o artefato de escopo/features no makuco-docs-mcp)_
...
- _Ex: artifact `<id>` — Glossário do Produto (v2), via makuco-docs-mcp — termos relevantes_
- _Ex: artifact `<id>` — Entrevista com usuário YYYY-MM-DD, via makuco-docs-mcp_
